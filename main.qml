...
import SceneGraphRenderingNoThread 1.0
...
Item {
    ...
    /*RendererNoThread {
        ...
        transform: [
            Rotation { id: rotation2; axis.x: 0; axis.z: 0; axis.y: 1; angle: 0; origin.x: renderer2.width / 2; origin.y: renderer2.height / 2; },
            Translate { id: txOut2; x: -renderer2.width / 2; y: -renderer2.height / 2 },
            Scale { id: scale2; },
            Translate { id: txIn2; x: renderer2.width / 2; y: renderer2.height / 2 }
        ]
    }*/
